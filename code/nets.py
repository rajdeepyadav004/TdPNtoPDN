...
class tdpn:
	"""
	A class to represent timed data nets
	"""


	def __init__(self):
		"""
		Creates variable associated with the class
		"""
	...
	def addPlaces(self, listOfPlaces):
		"""
		adds list of places to the transitions

		:type listOfPlaces: list of str
		:param listOfPlaces: list of places to be added in the net
		"""
...
class pdn:
	...
	def __init__(self):
		...
		self.initMarking=dict()
		self.finalMarking=dict()
		## each transition will be a tuple with format(list of places, list of data, input matrix, output matrix) with matrices as dict of dict
